...
public class SmartSpawnEditor : Editor {
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUI.BeginChangeCheck();
		GameObject goldenFish = (GameObject)EditorGUILayout.ObjectField("Golden Fish", s.goldenFish, typeof(GameObject), false);
		if (EditorGUI.EndChangeCheck())
		{
			Undo.RecordObject(target, "Change Golden Fish");
			s.goldenFish = goldenFish;
		}
